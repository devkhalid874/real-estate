...
@section('title', 'Add Buying and Selling Section')
    ...
    <div class="card my-4">
      <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center px-3">
          <h6 class="text-white text-capitalize mb-0">Add Buying and Selling</h6>
      ...
      <div class="card-body px-4 pb-4">
        <form action="{{ route('admin.buying_selling.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
